...
const Portfolio = () => {
    ...
    const portfolioTabControls = [
        { id: 1, title: 'Web', isActive: portfolioTab1, handler: handleShowPortfolioItems1 },
        { id: 2, title: 'UI/UX', isActive: portfolioTab2, handler: handleShowPortfolioItems2 },
        { id: 3, title: 'Backend', isActive: portfolioTab3, handler: handleShowPortfolioItems3 },
                ...
                {!isMobile && <div className={styles.portfolio__wrapper}>
                    <button className={styles.portfolio__more} onClick={toggleHiddenPortfolioItems}>
                        <span className={styles.portfolio__more__text}>
                            {hiddenPortfolioItems ? 'Close': 'Show all'}
                        </span>
